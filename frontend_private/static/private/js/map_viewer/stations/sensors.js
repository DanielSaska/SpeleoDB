                                            ...
                                            ${hasWriteAccess ? `
                                                <div class="flex gap-2 mt-4 pt-4 border-t border-slate-600/50">
                                                    ${canChangeSensorInstallStatus(install) ? `
                                                        <button onclick="window.StationSensors.loadEditForm('${Utils.escapeHtml(install.id)}', '${Utils.escapeHtml(stationId)}', '${Utils.escapeHtml(projectId)}')"
                                                            class="btn-secondary text-sm flex-1">
                                                            ✏️ Edit
                                                        </button>
                                                        <button onclick="window.StationSensors.showRetrieveModal('${Utils.escapeHtml(install.id)}', '${Utils.escapeHtml(stationId)}', '${Utils.escapeHtml(projectId)}')"
                                                            class="btn-secondary text-sm flex-1">
                                                            ✓ Mark as Retrieved
                                                        </button>
